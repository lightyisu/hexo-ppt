    ...
    $.fn.pptxToHtml = function (options) {
        ...
        function convertToHtml(file) {
            ...
            $("#all_slides_warpper").attr({
                style: trnsfrmScl + ";height:fit-content; " 
            })
        ...
        function initSlideMode(divId, settings) {
            ...
            if (settings.slideType == "" || settings.slideType == "divs2slidesjs") {
                ...
                setTimeout(function () {
                    ...
                    $("#all_slides_warpper").attr({
                        style: trnsfrmScl + ";height: " + (numOfSlides * slidesHeight * sScaleVal) + "rem"
                    })
        ...
        function processSingleSlide(zip, sldFileName, index, slideSize) {
            ...
            */
            ...
            if (settings.slideMode && settings.slideType == "revealjs") {
                var result = "<section class='slide' style='width:" + slideSize.width + "rem; height:" + slideSize.height + "rem;" + bgColor + "'>"
            } else {
                var result = "<div class='slide' style='width:" + slideSize.width + "rem; height:" + slideSize.height + "rem;" + bgColor + "'>"
            }
            result += bgResult;
        ...
        function processGroupSpNode(node, warpObj, source) {
            ...
            if (top !== undefined) {
                grpStyle += "top: " + top + "rem;";
            }
            if (left !== undefined) {
                grpStyle += "left: " + left + "rem;";
            }
            if (width !== undefined) {
                grpStyle += "width:" + width + "rem;";
            }
            if (height !== undefined) {
                grpStyle += "height: " + height + "rem;";
            }
            var order = node["attrs"]["order"];

            var result = "<div class='block group' style='z-index: " + 0+ ";" + grpStyle + " border:1px solid red;'>";
        ...
        function genShape(node, pNode, slideLayoutSpNode, slideMasterSpNode, id, name, idx, type, order, warpObj, isUserDrawnBg, sType, source) {
            ...
            if (shapType !== undefined || custShapType !== undefined /*&& slideXfrmNode !== undefined*/) {
                ...
                if (outerShdwNode !== undefined) {
                    ...
                    var dist = parseInt(outerShdwAttrs["dist"]) * slideFactor;//(rem) //* (3 / 4); //(pt)
                    //var rotWithShape = outerShdwAttrs["rotWithShape"];
                    var blurRad = (outerShdwAttrs["blurRad"]) ? (parseInt(outerShdwAttrs["blurRad"]) * slideFactor) : ""; //+ "rem"
                    ...
                    //css:
                    var svg_css_shadow = "filter:drop-shadow(" + hx + "rem " + vx + "rem " + blurRad + "rem #" + chdwClrNode + ");";
        ...
        */
        ...
        function genTextBody(textBodyNode, spNode, slideLayoutSpNode, slideMasterSpNode, type, idx, warpObj, tbl_col_width) {
            ...
            for (var i = 0; i < apNode.length; i++) {
                ...
                var sld_prg_width = ((prg_width_node !== undefined) ? ("width:" + (parseInt(prg_width_node) * slideFactor) + "rem;") : "width:inherit;");
                var sld_prg_height = ((prg_height_node !== undefined) ? ("height:" + (parseInt(prg_height_node) * slideFactor) + "rem;") : "");
                ...
                var prg_width = ((prg_width_node !== undefined) ? ("width:" + (prg_width_node )) + "rem;" : "width:inherit;");
        ...
        function genBuChar(node, i, spNode, textBodyNode, pFontStyle, idx, type, warpObj) {
            ...
            if (buFontSize === undefined) {
                ...
                if (buFontSize !== undefined) {
                    ...
                    var dfltBultSizeNoPt = parseInt(dfltBultSize, "rem");
                    bultSize = prcnt * (parseInt(dfltBultSizeNoPt)) + "rem";// + "pt";
                }
            } else {
                bultSize = (parseInt(buFontSize) / 100) * fontSizeFactor + "rem";
            }
            ...
            if (marRNode !== undefined) {
                ...
                marRStr += ((marginRight + indent < 0) ? 0 : (marginRight + indent)) + "rem;";
            }
            ...
            font_val = parseInt(bultSize, "rem");
            ////////////////////////////////////////////////////////////////////////
            if (buType == "TYPE_BULLET") {
                ...
                bullet += "'><div style='line-height: " + (font_val/2) + "rem;'>" + htmlBu + "</div></div>"; //font_val
                //} 
                // else {
                ...
                // } else {
                //     marginLeft = 328600 * slideFactor * lvl;
                //     bullet = "<div style='margin-left: " + marginLeft + "rem;";
                //     if (isRTL) {
            ...
            // else {
            //     bullet = "<div style='margin-left: " + 328600 * slideFactor * lvl + "rem" +
            //         "; margin-right: " + 0 + "rem;'></div>";
            // }
        ...
        function genSpanElement(node, rIndex, pNode, textBodyNode, pFontStyle, slideLayoutSpNode, idx, type, rNodeLength, warpObj, isBullate) {
            ...
            if (spcNode !== undefined) {
                ...
                styleText += "letter-spacing: " + ltrSpc + "rem;";// + "pt;";
            }
        ...
        function getPregraphMargn(pNode, idx, type, isBullate, warpObj){
            ...
            if ((indentNode !== undefined || marLNode !== undefined)) {
                ...
                if (isBullate) {
                    ...
                    marLStr += maginVal + "rem;";  // (minus bullate numeric lenght/size - TODO
                } else {
        ...
        function genGlobalCSS() {
            ...
            if (settings.slideMode && settings.slideType == "divs2slidesjs") {
                ...
                cssText += "#all_slides_warpper{margin-right: auto;margin-left: auto;padding-top:10px;width: " + slideWidth + "rem;}\n"; // TODO
            }
            return cssText;
        }
        ...
        function getPosition(slideSpNode, pNode, slideLayoutSpNode, slideMasterSpNode, sType) {
            ...
            if (off === undefined) {
                ...
                return (isNaN(x) || isNaN(y)) ? "" : "top:" + (y - offY + grpY) + "rem; left:" + (x - offX + grpX) + "rem;";
            }
        ...
        function getSize(slideSpNode, slideLayoutSpNode, slideMasterSpNode) {
            ...
            if (ext === undefined) {
                ...
                return (isNaN(w) || isNaN(h)) ? "" : "width:" + w + "rem; height:" + h + "rem;";
            }
        ...
        function getVerticalMargins(pNode, textBodyNode, type, idx, warpObj) {
            ...
            if (getTextByPathList(pNode, ["a:r"]) !== undefined) {
                ...
                if (fontSizeStr != "inherit") {
                    fontSize = parseInt(fontSizeStr, "rem"); //pt
                }
            }
            //var spcBef = "";
            ...
            if (lnSpcNode !== undefined && fontSize !== undefined) {
                if (lnSpcNodeType == "Pts") {
                    marginTopBottomStr += "padding-top: " + ((parseInt(lnSpcNode) / 100) - fontSize) + "rem;";//+ "pt;";
                } else {
                    ...
                    marginTopBottomStr += "padding-top: " + pBottom + "rem;";// + "pt;";
                    marginTopBottomStr += "padding-bottom: " + spcLines + "rem;";// + "pt;";
                }
            }

            //if (spcBefNode !== undefined || lnSpcNode !== undefined) {
            marginTopBottomStr += "margin-top: " + (spcBefor - 1) + "rem;";// + "pt;"; //margin-top: + spcLines // minus 1 - to fix space
            //}
            if (spcAftNode !== undefined || lnSpcNode !== undefined) {
                ...
                //marginTopBottomStr += "margin-bottom: " + spcAfter * (1 / 4) + "rem;";// + "pt;";
                marginTopBottomStr += "margin-bottom: " + spcAfter  + "rem;";// + "pt;";
            }
        ...
        function getFontColorPr(node, pNode, lstStyle, pFontStyle, lvl, idx, type, warpObj) {
            ...
            if (txtBrdrNode !== undefined && txtBrdrNode["a:noFill"] === undefined) {
                ...
                //var brdSize = (parseInt(txBrdAry[0].substring(0, txBrdAry[0].indexOf("pt")))) + "rem";
                var brdSize = (parseInt(txBrdAry[0].substring(0, txBrdAry[0].indexOf("rem")))) + "rem";
            ...
            if (txtGlowNode !== undefined) {
                ...
                if (colorType == "solid") {
                    ...
                    // } 
                    txtEffects.push(
                        "drop-shadow(0 0 " + rad / 3 + "rem #" + glowClr + ") " +
                        "drop-shadow(0 0 " + rad * 2 / 3 + "rem #" + glowClr + ") " +
                        "drop-shadow(0 0 " + rad + "rem #" + glowClr + ")"
                    );
                }
            }
            ...
            if (txtShadow !== undefined) {
                ...
                if (!isNaN(vx) && !isNaN(hx)) {
                    oShadowStr = hx + "rem " + vx + "rem " + blurRad + " #" + shadowClr;// + ";";
                    if (colorType == "solid") {
                        ...
                        //txtEffObj.oShadow = hx + "rem " + vx + "rem " + blurRad + " #" + shadowClr;

                        txtEffects.push("drop-shadow(" + hx + "rem " + vx + "rem " + blurRad + " #" + shadowClr + ")");
                    }
                }
        ...
        function getFontSize(node, textBodyNode, pFontStyle, lvl, type, warpObj) {
            ...
            return isNaN(fontSize) ? ((type == "br") ? "initial" : "inherit") : (fontSize * fontSizeFactor + "rem");// + "pt");
        }
        ...
        function getBackground(warpObj, slideSize, index) {
            ...
            var result = "<div class='slide-background-" + index + "' style='width:" + slideSize.width + "rem; height:" + slideSize.height + "rem;" + bgColor + "'>"
        ...
        function getBgPicFill(bgPr, sorce, warpObj, phClr, index) {
            ...
            bgcolor = "background: url(" + picFillBase64 + ");  z-index: " + 0 + ";" + prop_style + imgOpacity;
